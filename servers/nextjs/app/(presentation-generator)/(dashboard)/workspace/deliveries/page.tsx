...
import { EnterpriseApi, type DeliveryCenterResponse, type WorkspaceResponse } from "@/app/(presentation-generator)/services/api/enterprise";
...
export default function DeliveryCenterPage() {
  ...
  const load = useCallback(async () => {
    ...
    setLoading(true);
    try {
      setData(await EnterpriseApi.getDeliveryCenter(workspaceId, { sceneType, status, integrity, q: appliedQuery }));
      setError(null);
    } catch (cause) {
